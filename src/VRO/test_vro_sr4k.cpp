/*
 * October 1, 2016 David Z 
 * 
 * test for VRO using SwissRanger 4000 
 *
 * */
...
{
  ros::init(argc, argv, "vro_sr4k_test"); 
  ros::NodeHandle n;
  testTwoFrameMatch(); 
  return 0; 
}
...
void testTwoFrameMatch()
{
  ...
  tf::Transform tran = vo.VRO( tar_cv_i_img, tar_cv_d_img, src_cv_i_img, src_cv_d_img, 0.001); 
